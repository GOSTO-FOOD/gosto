...
import { ShoppingBag, ChevronDown, Zap, Award, Clock, Utensils } from "lucide-react";
    ...
    <section className="relative min-h-[100dvh] flex flex-col justify-center items-center overflow-hidden pt-20">
      ...
      <div className="container relative z-10 mx-auto px-4 text-center flex flex-col items-center gap-8 mt-6 mb-28">
        ...
        >
          ...
          <button
            onClick={openDineIn}
            className="group relative flex items-center gap-3 px-8 py-5 sharp font-display font-black text-sm uppercase tracking-widest overflow-hidden transition-all hover:scale-105"
            style={{
          ...
          >
            ...
            <span className="relative z-10">Commander sur Table</span>
          </button>

          <button
            onClick={() => document.getElementById("about")?.scrollIntoView({ behavior: "smooth" })}
            className="flex items-center gap-2 px-8 py-5 sharp font-display font-bold text-white/70 text-sm uppercase tracking-widest border border-white/15 hover:border-white/30 hover:text-white/90 transition-all"
          >
            Notre Histoire
          </button>
        </motion.div>
