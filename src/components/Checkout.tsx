...
import { X, User, Phone, MapPin, Send, CheckCircle, Loader2, Clock, ExternalLink } from "lucide-react";
                ...
                {sent ? (
                  <div className="px-7 py-10 flex flex-col items-center gap-5 text-center">
                    ...
                    <p className="text-white/50 text-sm max-w-xs leading-relaxed">
                      Votre commande a été reçue. Conservez votre code de suivi ci-dessous.
                    </p>
                    ...
                    <div className="flex items-center gap-2 text-xs text-white/25 font-bold uppercase tracking-wider">
                      ...
                      if (field.key === "address") {
                        return (
                          <div key="address" className="flex flex-col gap-2">
                            ...
                            />
                            {errors.address && (
                              <p className="text-xs text-red-400 font-medium">{errors.address}</p>
                            )}
                          </div>
                        );
                      }
